...
const CACHE_NAME = "ha-cache";
const OFFLINE_URL = "ha.offline.html";
// Files that will be cached on load.
const CACHED_FILES = ["ha.html","ha.js","ha.wasm","ha.pck","ha.offline.html","ha.icon.png","ha.apple-touch-icon.png"];
